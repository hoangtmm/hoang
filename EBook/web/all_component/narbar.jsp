...
<div class="container-fluid p-3 bg-light">
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <a href="register.jsp" class="btn btn-primary text-white"><i class="fa-solid fa-registered"></i> Register</a>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
            <button class="btn btn-light my-2 my-sm-0 mr-2" type="submit"><i class="fa-solid fa-gears"></i> Setting</button>
